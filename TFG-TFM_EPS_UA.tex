...
\usepackage{pdfpages}
\usepackage{caption}
\usepackage{hyperref} % si usas referencias

%Para añadir la tabla:
\usepackage{booktabs}
\usepackage{array}
\usepackage{ragged2e}
\usepackage{tabularx}
\usepackage{xltabular}      % = longtable + tabularx
\usepackage[table]{xcolor}  % evita que salga "3gray!10white"


% Definición de un nuevo tipo de columna (en el preámbulo)
...
\input{capitulos/estudio de la viabuilidad}	% Plantilla: Se muestran listas
\input{capitulos/objetivos}		% Plantilla: Se muestran tablas
\input{capitulos/estado del arte}	% Plantilla: Se muestran figuras
