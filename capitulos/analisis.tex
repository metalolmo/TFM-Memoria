...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{imagenes/image19.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{imagenes/image21.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{imagenes/image25.png}
...
Como resultado la conexión SSH se estableció correctamente desde Ubuntu, con autenticación local en el router y cifrado de la sesión, confirmando que el protocolo SSH queda operativo para su uso por el backend (FastAPI + Paramiko)
